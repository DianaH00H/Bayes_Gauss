...
Para poder agregar una variable discreta tenemos 3 opciones.
1. Codificar la variable, pero esto hara que pierda su valor probabilistico.
2. Discretizar todas las variables, pero si hacemos eso no podremos hacer nuestro queries.
3. Hacer una red bayesiana hibrida teniendo la variable categorica como factor


## Mejor estructura:
La mejor opcion es la 3, asi que cambiaremos sex a factor
La mejor dag fue la 2, asi que la vamos a rehacer incluyendo el sexo
Luego vamos a crear la nueva red bayesiana y a comparar su efectividad
